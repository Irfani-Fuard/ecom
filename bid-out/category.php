            ...
            <div class="page-content mb-10">
                <div class="shop-default-banner shop-boxed-banner banner d-flex align-items-center mb-6"
                    ...
                    <div class="container banner-content">
                        ...
                        <h3 class="banner-title text-white text-uppercase font-weight-bolder ls-10"><?php echo $_GET['category']; ?></h3>
                    ...
                    <div class="shop-content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="product-wrapper row cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                                ...
                                $ret = "SELECT * FROM  bidding_product JOIN features ON  bidding_product.feature_id=features.id WHERE  bidding_product.category_id='$name' ";
