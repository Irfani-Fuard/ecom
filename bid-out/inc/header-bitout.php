            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <a href="http://localhost/ecom/bid-out/seller/dashboard.php" class="btn btn-primary">Sell</a>
                        <a href="#" class="d-lg-show">Contact Us</a>
                        <a href="#" class="d-lg-show">My Account</a>
                        <a href="assets/ajax/login.php" class=" login sign-in"><i class="w-icon-account"></i>SignIn</a>
                ...
                <div class="container">
                    <div class="header-left mr-md-2">
                        ...
                        <a href="demo1.html" class="logo ml-lg-0">
                            <img src="images/eslogo.jpg" alt="logo" style="width:50px !important" />
                        </a>
                    ...
                    <div class="inner-wrap">
                        <div class="header-left">
                            <!--<a href="index.php" class="logo ml-lg-0">
                                <img src="images/eslogo1.jpg" alt="logo" />
                            </a>-->
                            <div class="dropdown category-dropdown has-border" data-visible="true">
                                <a href="category.php" class="category-toggle text-dark" role="button"
                            ...
                            <nav class="main-nav">
                                <ul class="menu">
                                    ...
                                    <li class="has-submenu">
                                        ...
                                        ?>
                                            <li><a href="features.php?fid=<?= $row['id'] ?>&name=<?= $row['name'] ?>">
                                                    <?= $row['name'] ?></a></li>
                                            <?php    
                                        }?>
                                        </ul>
                            ...
                            $path = "http://localhost/ecom/bid-out/seller/";
                            $path3 = "http://localhost/ecom/bid-out/seller/upload/";
                            ?>
                                    <li class="">
                                        <a href="http://localhost/ecom/bid-out/seller/dashboard.php">Dashboard</a>
                                    </li>
                                    <li class="">
