                    ...
                    <div class="container banner-content">
                        ...
                        <?php  
                            if(isset($_GET['name'])){
                                $name=$_GET['name'];
                        ?>
                        <h3 class="banner-title text-white text-uppercase font-weight-bolder ls-10"><?php echo $name;?></h3>
                        <?php }?>
                    </div>
                </div>
                <!-- End of Shop Banner -->
                    ...
                    <div class="shop-content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="product-wrapper row cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                                ...
                                $ret = "SELECT * FROM bidding_product JOIN features ON bidding_product.feature_id=features.id WHERE bidding_product.feature_id ='$fid' ";
