            ...
            <div class="page-content mb-10">
                <div class="shop-default-banner shop-boxed-banner banner d-flex align-items-center mb-6"
                    ...
                    <div class="container banner-content">
                        ...
                        ?>
                        <h3 class="banner-title text-white text-uppercase font-weight-bolder ls-10"><?php echo $status;?></h3>
                        <?php }?>
                    </div>
                </div>
                <!-- End of Shop Banner -->
                        ...
                        <div class="main-content">
                            ...
                            <div class="product-wrapper row cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                               ...
                               /* if(isset($_GET['status'])){
                                ...
                                $ret = "SELECT * FROM product WHERE pstatus ='$status' ";
                                //$ret = "SELECT * FROM product JOIN  category  ON product.category _id= category.id WHERE product.pstatus ='$status' ";
