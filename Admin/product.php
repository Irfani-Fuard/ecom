    ...
    <!-- Main content -->
            ...
            <div class="card-body">
              ...
              ||
                ...
                data-feature="<?php echo $row["feature_id"]; ?>"
                data-pstatus="<?php echo $row["pstatus"]; ?>" 
                data-category ="<?php echo $row["name"]; ?>"
                data-price="<?php echo $row["price"]; ?>"
                data-cutoff-price="<?php echo $row["cutoff_price"]; ?>"
...
<div id="editProductModal" class="modal fade">
      ...
      <form id="edit_form"  method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="feature_u">Features</label>
              <select class="form-control" name="feature_u" id="feature_u">
                  <?php echo   $name_list_u; ?>
              </select>
              <span class="error" id="feature_u_err"> </span>
						</div>
            <div class="form-group">
              <label for="status_u">Status</label>
              <select class="form-control" name="status_u" id="status_u">
                  <option value="0">--Select--</option>
                  <option value="Brand New">Brand New</option>
                  <option value="Like New">Like New</option>
                  <option value="Lightly Used">Lightly Used</option>
              ...
              <span class="error" id="status_u_err"> </span>
						</div>
						<div class="form-group">
							<label>Description</label>
            ...
            <div class="form-group">
                  <label for="photo_u">Featured Image</label>
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" id="photo_u" name="photo_u" class="custom-file-input" accept="image/*">
                      <label class="custom-file-label" for="photo_u">Choose file</label>
                    </div>
                    <div class="input-group-append">
                      <span class="input-group-text">Upload</span>
                    </div>
            ...
            <div class="form-group">
                  <label for="file_u">Add more images</label>
                  <div class="input-group">
                    <div class="custom-file">
                    <input type="file" name="file_u[]" id="file_u" multiple>
                      <label class="custom-file-label" for="file_u">Choose file</label>
                    </div>
                    <div class="input-group-append">
                      <span class="input-group-text">Upload</span>
                    </div>
                  </div>
                  <span class="error" id="file_u_err"> </span>
             </div>
                <!--multiple images -->
            <div class="form-group">
							<label>Price</label>
            ...
            <div class="form-group">
							<label>Cutoff Price</label>
							<input type="number" id="cprice_u" name="cprice_u" class="form-control" required>
							<span class="error" id="cprice_u_err"> </span>
						</div>					
            <div class="form-group">
							<label>Stock</label>
