        ...
        if (!checkuser()) {
            ...
            $.ajax({
                ...
                success: function (data) {
                  console.log("success");
                    $('#message').html(data);
                    // window.location.href = "http://localhost/ecom/Admin/dashboard.php";
                },
                complete: function () {
...
function checkpass() {
    ...
    if (pass === "") {
        ...
        $('#password_err').html('Password must be at least 8 characters long');
        return false;
    } else if (!validpass) {
        $('#password_err').html('Password must contain at least one uppercase letter, one lowercase letter, one digit, and one special character');
        return false;
    } else {
        $('#password_err').html("");
        return true;
